...
const CaseStudyTestimonials = () => {
  ...
  const testimonial: Testimonial = {
    ...
    content:
      "This platform completely transformed how we handle quotes and scheduling. We've eliminated errors and our team is so much more efficient now. The ROI was immediate and continues to grow every month.",
    type: "text",
  };
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Hear directly from the PriceUp team about how the platform has
