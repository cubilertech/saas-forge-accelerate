...
const PipaCaseStudy = () => {
  ...
  const keyFeatures = [
    ...
    },
    {
      ...
      detailedDescription:
        "Communication is the lifeblood of a farm, but relying on personal text messages leads to missed information and a lack of clear records. We implemented a secure, real-time chat feature directly within the Pipa platform. This gives teams a centralized place for all job-related communication, ensuring everyone is working from the same information, at the same time.",
    ...
    },
    {
      ...
      detailedDescription:
        "Safety is paramount on a farm. We built a dedicated safety module to manage and track safety briefings, pre-start checklists, and incident reports. This creates a clear, auditable trail, reduces administrative burden, and helps farm managers foster a powerful safety culture.",
            ...
            <div className="space-y-4">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
                ...
                <span className="text-gradient-primary">
                  Mission-Critical Farm Management Platform
                </span>
              </h1>
              <p className="hidden md:block text-lg md:text-xl text-muted-foreground leading-relaxed max-w-4xl mx-auto">
                People in Paddocks (Pipa) was built on a powerful vision: to
                bring order to the chaos of managing a mobile farm workforce.
                They had a promising initial application, but it was plagued by
                critical bugs and an unstable backend that stalled their growth.
                We partnered with them to take over the project, transforming
                their unreliable app into a professional, scalable business
                asset.
              </p>
            </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Pipa was running on an application that couldn't support its
              business goals. The system was creating constant frustration for
              users with frequent crashes, data inconsistencies, and a slow,
              confusing user experience. This technical instability created a
              massive business problem: it{" "}
              <strong>
                prevented the Pipa team from confidently onboarding new farms
                and scaling their operations
              </strong>
              , threatening the entire venture.
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="text-center mb-20 px-6">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            We conducted a deep audit and executed a three-phase mission:{" "}
            <strong>Stabilize, Rebuild, and Enhance.</strong> The result was a
            robust platform with the critical features farm managers need to
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {results.map((result, index) => (
              <Card
                key={index}
                className="bg-gradient-card hover-glow text-center p-6"
              >
      ...
      <section className="px-6 py-16 bg-muted/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              We chose the right tools for reliability, performance, and
          ...
          <Card className="bg-gradient-card p-12 border border-border/10 rounded-3xl">
            <CardContent className="space-y-8">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                ...
                business impact, just like we did with Pipa.
              </p>
