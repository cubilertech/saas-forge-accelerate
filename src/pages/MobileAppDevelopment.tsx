...
const MobileAppDevelopment = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative px-6 pt-32 pb-0 md:pt-40 overflow-hidden bg-gradient-hero bg-mesh">
        {/* Service Tags */}
        <div className="relative max-w-4xl mx-auto text-center space-y-6 animate-fade-in">
          <div className="flex flex-wrap justify-center gap-3 mb-2">
            {["App Dev", "UI / UX", "Design", "Website"].map((tag, i) => (
              <span
                key={i}
                className="px-5 py-2 rounded-full border border-border/40 text-sm font-medium text-foreground/70 bg-card/40 backdrop-blur-sm hover:border-primary/40 hover:text-primary transition-all duration-300 cursor-default"
              >
                {tag}
              </span>
            ))}
          ...
          <p className="text-lg text-muted-foreground font-medium">We help you</p>
          ...
          <p className="text-base sm:text-lg text-muted-foreground/90 leading-relaxed max-w-2xl mx-auto font-medium">
            We're a modern app-building company that creates apps your customers love and that evolve with your business.
          </p>

          <div className="flex flex-wrap justify-center gap-4 pt-2">
            <a href={bookCallUrl} target="_blank" rel="noopener noreferrer">
              <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-6 text-base font-bold rounded-xl transition-all duration-300 hover:shadow-2xl hover:shadow-primary/40 hover:scale-105">
                Contact Us
              </Button>
            </a>
            <a href={bookCallUrl} target="_blank" rel="noopener noreferrer">
              <Button size="lg" variant="outline" className="glass-effect border-border/40 text-foreground px-8 py-6 text-base font-semibold rounded-xl hover:bg-primary/10 hover:border-primary/50 transition-all duration-300">
                Book Meeting
              </Button>
            </a>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto mt-16 pb-4">
          <div className="grid grid-cols-12 gap-4 items-start">
            {/* Stats Widget - left */}
            <div className="col-span-12 md:col-span-4 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              <img
                src={showcaseStatsWidget}
                alt="Analytics stats widget"
                className="rounded-2xl shadow-lg w-full hover:scale-[1.02] transition-transform duration-500"
                loading="lazy"
                width={640}
                height={512}
              />
            ...
            {/* Mobile App - center */}
            <div className="col-span-12 md:col-span-4 flex justify-center animate-fade-in" style={{ animationDelay: "0.4s" }}>
              <img
                src={showcaseMobileApp}
                alt="Mobile shopping app UI"
                className="rounded-2xl shadow-2xl w-full max-w-[280px] hover:scale-[1.02] transition-transform duration-500"
                loading="lazy"
                width={512}
                height={1024}
              />
            ...
            {/* HR Dashboard - right */}
            <div className="col-span-12 md:col-span-4 animate-fade-in" style={{ animationDelay: "0.6s" }}>
              <img
                src={showcaseDashboard2}
                alt="HR team management dashboard"
                className="rounded-2xl shadow-lg w-full hover:scale-[1.02] transition-transform duration-500"
                loading="lazy"
                width={1024}
                height={640}
            ...
            {/* Full-width dashboard below */}
            <div className="col-span-12 md:col-span-8 md:col-start-3 -mt-8 md:-mt-16 animate-fade-in" style={{ animationDelay: "0.8s" }}>
              <img
                src={showcaseDashboard1}
                alt="SaaS analytics dashboard"
                className="rounded-2xl shadow-xl w-full hover:scale-[1.01] transition-transform duration-500"
                loading="lazy"
                width={1024}
                height={640}
              />
