  ...
  const keyFeatures = [
    {
      ...
      detailedDescription:
        "The core of PriceUp's revenue leakage was their manual, spreadsheet-based quoting process. It was slow, inconsistent, and prone to costly errors. We developed a dynamic, step-by-step engine that acts as a foolproof checklist. Users select glass types, hardware, and labor rates from a pre-defined library, ensuring every single cost is captured, every single time.",
    ...
    },
    {
      ...
      subtitle:
        "Visualize all jobs and manage crew assignments from one dashboard.",
      detailedDescription:
        "The old whiteboard system for scheduling crews was a recipe for chaos and confusion. We built a visual, drag-and-drop scheduler that provides a single source of truth for all active jobs and crew availability. Project managers can assign specific tasks to installers, who can see their daily schedule on any device.",
          ...
          <div className="text-center space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="hidden md:block text-lg md:text-xl text-muted-foreground leading-relaxed max-w-4xl mx-auto">
                PriceUp was running their multi-million dollar business on a
                chaotic system of spreadsheets and paper forms. We partnered
                with them to build a custom, end-to-end software platform from
                scratch, transforming their operations and boosting their
                profitability.
              </p>
            </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              PriceUp was running a multi-million dollar glass installation
              business on spreadsheets, paper forms, and manual processes. This
              chaotic system was creating costly errors, frustrated customers,
              and significant revenue leakage that threatened their growth.
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="text-center mb-20 px-6">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            We built a comprehensive platform from scratch that transformed
            their chaotic processes into a streamlined, profitable operation
          </p>
        </div>
      ...
      <section className="px-6 py-16 bg-muted/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              We chose the right tools for scalability, performance, and
              maintainability
            </p>
          </div>
          ...
          <Card className="bg-gradient-card p-12 border border-border/10 rounded-3xl">
            <CardContent className="space-y-8">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Let's discuss how we can help you create a solution that drives
                real business impact, just like we did with PriceUp.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
      ...
      <footer className="px-6 py-12 border-t border-border/20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-sm">
            © 2024 Cubiler Technologies. Ready to build something amazing
            together.
          </p>
        </div>
      </footer>
