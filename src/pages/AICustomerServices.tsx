    ...
    },
    {
      ...
      visual: (
        <div className="mt-4 flex gap-1 items-end justify-center h-12">
          ...
          <div
            className="w-2 h-10 bg-red-500/50 rounded animate-pulse"
            style={{ animationDelay: "0.1s" }}
          ></div>
          <div
            className="w-2 h-12 bg-red-500/50 rounded animate-pulse"
            style={{ animationDelay: "0.2s" }}
          ></div>
          <div
            className="w-2 h-9 bg-red-500/50 rounded animate-pulse"
  ...
  const features = [
    {
      ...
      description:
        "Custom AI trained on your business. Instant professional responses.",
      stat: "99.9% Uptime",
      diagram: (
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
          ...
          <div className="animate-fade-in">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              <span className="text-primary">
                Automate Multi-channel Cusotmer Support with AI.
              </span>{" "}
      ...
      <section
        id="demo"
        data-animate
        className={`px-6 py-20 bg-gradient-to-b from-background to-primary/5 transition-all duration-1000 ${
          isVisible("demo")
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              <span className="text-primary">
                "UK Auto Service Centre" Demo
              </span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              We built this AI for a busy UK auto service centre handling MOT
              tests, full services, and repairs. It's trained on their complete
              service catalog, DVSA-approved standards, and can book
              appointments in their actual calendar.
              <strong className="text-foreground">
                {" "}
                Watch these real demo videos
              </strong>{" "}
              to see how our AI handles customer interactions across all
              channels.
            </p>
          </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center md:text-left">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Busy UK service centre at 24 Hill Street, London. MOT tests,
                    repairs, detailing. Mon-Sat: 9 AM - 6 PM
                  </p>
                </div>
                <div className="text-center md:text-left">
                  <div className="flex items-center gap-2 mb-2 justify-center md:justify-start">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Peak hour call overflow, MOT booking confusion, service
                    package questions, missed walk-ins
                  </p>
                </div>
                <div className="text-center md:text-left">
                  <div className="flex items-center gap-2 mb-2 justify-center md:justify-start">
                  ...
                  <p className="text-sm text-muted-foreground">
                    AI trained on DVSA standards, complete service catalog,
                    pricing, and live calendar integration
                  </p>
                </div>
              </div>
            </CardContent>
                      ...
                      <div>
                        ...
                        <ul className="space-y-2 text-sm">
                          <li className="flex items-start gap-2">
                            ...
                            <span>
                              <strong>MOT Test</strong> - Class 4 for cars &
                              small vans
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                            <span>
                              <strong>Full Service</strong> - Oil, filters,
                              brakes, fluids, inspection
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                            <span>
                              <strong>Car Repair</strong> - Engine, AC,
                              electrical, body
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                            <span>
                              <strong>Car Wash & Detailing</strong> - Interior +
                              exterior
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <ul className="space-y-2 text-sm mb-6">
                          <li className="flex items-start gap-2">
                            ...
                            <span>
                              <strong>Location:</strong> 24 Hill Street, London
                              (near Tesco Express)
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                          ...
                          <li className="flex items-start gap-2">
                            <Car className="h-4 w-4 text-primary mt-0.5 flex-shrink-0" />
                            <span>
                              All makes & models (Ford, BMW, Audi, Mercedes,
                              Toyota)
                            </span>
                          </li>
                        </ul>
            ...
            <Card className="bg-gradient-card hover-glow group overflow-hidden border border-border/10">
              <CardContent className="p-8 text-center flex flex-col h-full">
                ...
                <Button
                  ...
                  className="w-full bg-primary mb-12 mt-24"
                >
                  Launch Chat
                </Button>
          ...
          <div className="mt-12 p-6 bg-primary/5 rounded-lg border border-primary/10">
            <h4 className="text-center font-semibold mb-6 text-lg">
              How It Works
            </h4>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              We don't do one-size-fits-all. We build the exact modules you need
              to solve your biggest operational headaches, starting with what
              matters most to you.
            </p>
          </div>
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="mt-16 p-6 rounded-xl bg-gradient-to-r from-primary/5 to-primary/10 border border-primary/20 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Voice AI → Multi-channel → Full automation
              </p>
            </div>
          </div>
        </div>
          ...
          <Card className="bg-gradient-card hover-glow overflow-hidden border border-border/10">
            <CardContent className="p-12 md:p-16">
              ...
              <p className="text-lg text-muted-foreground mb-4 max-w-3xl mx-auto text-center">
                Get a free 15-minute consultation where we'll show you exactly
                how AI can handle your customer calls, texts, and chats. No
                generic pitch—we'll review your business and create a custom
                automation plan.
              </p>
              ...
              <div className="mb-8 flex justify-center">
                <div className="flex items-center gap-3 px-6 py-3 rounded-full glass-effect border border-primary/20">
                  <div className="flex -space-x-2">
                    <div className="w-8 h-8 rounded-full border-2 border-background bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white text-xs font-bold">
                      JD
                    </div>
                    <div className="w-8 h-8 rounded-full border-2 border-background bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center text-white text-xs font-bold">
                      SM
                    </div>
                    <div className="w-8 h-8 rounded-full border-2 border-background bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center text-white text-xs font-bold">
                      RK
                    </div>
                  </div>
                  <div className="text-left">
              ...
              <div className="border-t border-border/20 pt-8">
                <p className="text-sm text-muted-foreground mb-6 font-semibold text-center">
                  What Happens Next:
                </p>
                ...
                <Collapsible>
                  ...
                  <CollapsibleContent className="mt-4 space-y-3 text-left max-w-2xl mx-auto">
                    <div className="p-3 rounded-lg bg-muted/30">
                      ...
                      <p className="text-xs text-muted-foreground">
                        We handle everything. You just talk to us, we do the
                        setup.
                      </p>
                    </div>
                    <div className="p-3 rounded-lg bg-muted/30">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Transparent pricing based on your needs. Get a custom
                        quote in the demo.
                      </p>
                    </div>
                    <div className="p-3 rounded-lg bg-muted/30">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Yes, no long-term contracts required.
                      </p>
                    </div>
                  </CollapsibleContent>
                </Collapsible>
